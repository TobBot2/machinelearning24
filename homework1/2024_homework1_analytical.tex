...
$p(x_i | \theta) = \frac{1}{\sqrt{2\pi\sigma^2}} e^{-\frac{(x-\mu)^2}{2\sigma^2}}$\\
$\mathcal{L}(\theta) = \prod_{i=1}^{n} \frac{1}{\sqrt{2\pi\sigma^2}} e^{-\frac{(x-\mu)^2}{2\sigma^2}}$\\
$\log{\mathcal{L}(\theta)} = \ell(\theta) = \sum_{i=1}^{n}\log(\frac{1}{\sqrt{2\pi\sigma^2}})+\log(e^\frac{(x-\mu)^2}{2\sigma^2})$\\
$\ell(\theta) = \sum_{i=1}^{n}\log(\frac{1}{\sqrt{2\pi\sigma^2}}) + \frac{(x-\mu)^2}{2\sigma^2}$
